...
import (
	...
	payments_amqp_interface "github.com/codeabuu/ECartMonolith-Microservice/pkg/payments/interfaces/amqp"
...
func (i AMQPService) InitializedOrderPayment(id orders.ID, price price.Price) error {
	...
	if err != nil {
		return errors.Wrap(err, "cnt marshall order for amqp")
	}
	...
	if err != nil {
		return errors.Wrap(err, "cant send order to amqp")
	}
